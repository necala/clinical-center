...
public class OxygenProblemTest {
	...
	private void runPositiveTest(KieSession kieSession){
		...
		assertThat(mi.getIssue(), equalTo(MonitoringIssue.Issue.OXYGEN_ISSUE));
		
		String message = "Patient: Marija Manojlovic [ 1585 ] has some serious Oxygen Level issue!";
	...
	private void runRealtimePositiveTest(KieSession ksession) {
        ...
        ksession.getAgenda().getAgendaGroup("oxygen-event").setFocus();
